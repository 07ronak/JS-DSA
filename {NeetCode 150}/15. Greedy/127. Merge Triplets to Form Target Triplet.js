...
Example 3:
    ...
    Output: true
    Explanation: Perform the following operations:
                - Choose the first and third triplets [[2,5,3],[2,3,4],[1,2,5],[5,2,3]]. Update the third triplet 
                to be [max(2,1), max(5,2), max(3,5)] = [2,5,5]. triplets = [[2,5,3],[2,3,4],[2,5,5],[5,2,3]].
...
var mergeTriplets = function (triplets, target) {
  if (triplets.includes(target)) return true;
